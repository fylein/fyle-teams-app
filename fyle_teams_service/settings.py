"""
Django settings for fyle_teams_service project.
...
DEBUG = DEBUG = True if os.environ.get('DEBUG') == 'True' else False
...
MIDDLEWARE = [
    'fyle_teams_service.exception_middleware.CustomExceptionMiddleware',
...
ROOT_URLCONF = 'fyle_teams_service.urls'
...
WSGI_APPLICATION = 'fyle_teams_service.wsgi.application'
...
LOGGING = {
    ...
    'formatters': {
        'verbose': {
            'format': '{levelname} %s {asctime} {module} {message} ' % 'fyle-teams-service',
            'style': '{',
        },
        'requests': {
...
FYLE_TEAMS_APP_SEGMENT_KEY = os.environ['FYLE_TEAMS_APP_SEGMENT_KEY']
